...
private boolean isDotted = false;
  ...
  public void newQuantize(boolean toSwing)
   ...
   public void openActiveTradingWindow()
     ...
     * MIDI capture
     */
    public int[] getRealtimeQuanta()
    {
        return realtimeQuantizationDialog.getQuanta();
    }
    
    /**
     * @return boolean indicating the swing for realtime MIDI capture
     */
    public boolean getRealtimeSwing()
    {
        return realtimeQuantizationDialog.getSwing();
    }
     ...
     */
    public int getRealtimeRestAbsorption()
    {
        return realtimeQuantizationDialog.getRestAbsorption();
    }
