 ...
 */
public class DiversityIndex extends Metric{
    
    public DiversityIndex(double weight){
        super(weight, "diversityIndex", true);
    }
    ...
    public double compute(String ruleString, IndexedMelodyPart exactMelody, Polylist rule){
        this.value = getMelodyRhythmCount(exactMelody, getStartBeat(exactMelody)).getDiversityIndex();
        return this.value;
    }
