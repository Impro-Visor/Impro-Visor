...
//            case INTERPOLATE:
//            {
//                style.interpolations = style.interpolations.cons(Interpolant.makeInterpolantFromExp(item));
//               
//                break;
//            }
//            default:
...
//        
//        if(pc.getRoot().equals("g")) pc.transpose(8 + PitchClass.findRiseToC(c.getRoot()));
//        else pc.transpose(8+PitchClass.findRiseToC(c.getRoot()));
...
//      {
//       
//        if (nth == random) return (Chord)A.first();
//        else nth++;
//        
//      }
//   
...
//    if (list.isEmpty() || (boolean)list.first()) return Polylist.list((start+1),list.rest());
//    else return findCorrectDuration(list.rest(),start++);
//   
//}  
//public long render(MidiSequence seq,
//                   long time,
...
//            
//              if (chordPart.getChord(index) != null && interpolations.nonEmpty()) {
//                  Chord newChord = getPC(chordPart.getChord(index));
//
//                  Polylist finder = Interpolate.ArraytoPoly(chordPart.getBlock(blockIndex).flattenBlock());
...
//                  Polylist willInterp = Interpolate.willInterpolate(chordPart.getBlock(blockIndex), currentChord);
...
//                          currentChord.setRhythmValue(minVal * (int) findCorrectDuration(willInterp, minVal / 120).first());
//                          newChord.setRhythmValue(originalRV - minVal * (int) findCorrectDuration(willInterp, minVal / 120).first());
//                          //currentChord.setRhythmValue(currentChord.getRhythmValue()/2);
//                          //newChord.setRhythmValue(currentChord.getRhythmValue());
//                          System.out.println("currentchord going into previous chord: " + currentChord + "and index: " + index);
...
//                          System.out.println("interpolated chord: " + newChord + " and index: " + index);
//                          previousChord = makeChordline(seq,
//                                  time,
//                                  newChord,
//                                  previousChord,
...
//
//                  } else {
//                      System.out.println("current chord outside if: " + currentChord + "and index: " + index);
//                      previousChord = makeChordline(seq,
//                              time,
//                              currentChord,
//                              previousChord,
