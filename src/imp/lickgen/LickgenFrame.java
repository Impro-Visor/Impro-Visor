...
private void gradeGoodBtnActionPerformed(java.awt.event.ActionEvent evt)
 {
    ...
    private void initComponents() {
        ...
        motifWindowSizeLabel = new javax.swing.JLabel();
        motifWindowSizeField = new javax.swing.JTextField();
        ...
        motifWindowSizeLabel.setLabelFor(motifWindowSizeField);
        motifWindowSizeLabel.setText("Window Size");
        motifWindowSizeLabel.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        jPanel1.add(motifWindowSizeLabel);

        motifWindowSizeField.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        ...
        jPanel1.add(motifWindowSizeField);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        windowParametersPanel.add(jPanel1, gridBagConstraints);
...
public MelodyPart fillAndReturnMelodyFromText(String r, ChordPart chordPart)
  {
    ...
    private void motifWindowSizeFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_motifWindowSizeFieldActionPerformed
        CreateGrammar.setMotifWindowSizeAndSlide(Integer.parseInt(motifWindowSizeField.getText()));
        
    }//GEN-LAST:event_motifWindowSizeFieldActionPerformed
    ...
    private void motifWindowSizeFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_motifWindowSizeFieldFocusLost
        CreateGrammar.setMotifWindowSizeAndSlide(Integer.parseInt(motifWindowSizeField.getText()));
...
private void updateUseSoloist()
  {
    ...
    private javax.swing.JTextField motifWindowSizeField;
    private javax.swing.JLabel motifWindowSizeLabel;
