 ...
 * @author keller
 */
public class AdviceForCell
        extends AdviceForMelody
  {
  public AdviceForCell(String name, Polylist notes, String chordRoot, Key key,
                        int[] metre, int profileNumber)
    {
    super(name, 0, notes, chordRoot, key, metre, null, profileNumber);
    }

  public AdviceForCell(String name, int serial, Polylist notes,
