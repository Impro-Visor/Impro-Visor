 ...
 * @author keller
 */
public class AdviceForScale
        extends AdviceForMelody
  {
  public AdviceForScale(String name, Polylist notes, String chordRoot, Key key,
                        int[] metre, int profileNumber)
    {
    super(name, 0, notes, chordRoot, key, metre, null, profileNumber);
    }

  public AdviceForScale(String name, int serial, Polylist notes,
