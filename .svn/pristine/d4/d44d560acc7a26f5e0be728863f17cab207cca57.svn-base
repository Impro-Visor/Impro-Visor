 ...
 */
public class DictionaryToEditorCommand implements Command {
     ...
     */
    public DictionaryToEditorCommand(String filename, BasicEditor sourceEditor) {
    ...
    public void execute() {
        try {
            ...
            ErrorLog.log(ErrorLog.WARNING, "Cannot read from Dictionary file");
        }
    }
